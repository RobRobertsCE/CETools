...
namespace BranchVersionLibrary
{
    public static class BranchVersionHelper
    {
        ...
        static BranchVersionHelper()
        {
            ...
            var develop = GetVersionOnDate(DateTime.Now);
            //var alpha = new Version(develop.Major, develop.Minor - 1);
            var master = new Version(develop.Major, develop.Minor - 1);
            _map = new BranchMap(master, develop);
        }
    ...
    public class BranchMap
    {
        ...
        public BranchMap(Version masterVersion, Version developVersion)
        {
            Initialize(masterVersion, developVersion);
        }

        void Initialize(Version masterVersion, Version developVersion)
        {
            ...
            MasterBranch.Parent = DevelopBranch;
