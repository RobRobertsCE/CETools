...
{
    public class ChangedAssembyHelper
    {
        #region consts
        ...
        #region ctor           
        public ChangedAssembyHelper(IList<string> filesChanged, string repoName, string winUser)
        {
            this.WinUserName = winUser;
            this.RepoName = repoName;
            _changedFiles = filesChanged.Where(f => !f.Contains("UnitTest")).ToList();
